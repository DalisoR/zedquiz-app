    ...
    return (
        <div className="main-container">
            <header className="main-header super-admin-header">
                ...
                <button className="back-button" onClick={() => setPage('super-admin')}>Back to List</button>
            </header>
            <div className="content-body">
                <div className="card">
                    ...
                    <div className="document-links">
                        ...
                        <button onClick={() => viewDocument(application.certificates_url)}>View Certificates</button>
                    </div>
                </div>
                <div className="card decision-card">
                    <h3>Make a Decision</h3>
                    <div className="decision-buttons">
                        <button className="approve-button" onClick={() => handleDecision('approve')} disabled={loading}>
                            {loading ? 'Processing...' : 'Approve Application'}
                        </button>
                        <button className="reject-button" onClick={() => handleDecision('reject')} disabled={loading}>
