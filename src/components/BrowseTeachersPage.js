                        ...
                        <div className="teachers-grid">
                            {teachers.map(teacher => (
                                <div key={teacher.user_id} className="teacher-card">
                                    <img src={teacher.profile_picture_url || '[https://placehold.co/150x150](https://placehold.co/150x150)'} alt={teacher.full_name} className="teacher-pfp" />
                                    ...
                                    <button className="view-profile-btn" onClick={() => handleViewProfile(teacher)}>View Profile</button>
                                </div>
                            ))}
                        </div>
                    ) : (
