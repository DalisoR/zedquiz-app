    ...
    <div className="main-container">
      ...
      <div className="content-body">
        ...
        <div className="card">
          ...
          {/* Add Question Form */}
          {showAddQuestion && (
            <div style={{ border: '1px solid #e5e7eb', borderRadius: '8px', padding: '1rem', marginBottom: '1rem', background: '#f9fafb' }}>
              ...
              <form onSubmit={handleAddQuestion}>
                ...
                <div style={{ display: 'flex', gap: '0.5rem' }}>
                  <button type="submit" style={{ width: 'auto' }}>Add Question</button>
                  <button
                    type="button"
