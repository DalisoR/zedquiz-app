    ...
    <div className='landing-container'>
      <header className='landing-header'>
        ...
        <nav className='nav-buttons'>
          <button
            className='nav-button find-teacher-btn'
            onClick={() => setPage('browse-teachers')}
          >
            Find a Teacher
          </button>
          <button className='nav-button tutor-button' onClick={() => setPage('tutor-application')}>
            Become a Teacher
          </button>
          <button className='nav-button' onClick={() => setPage('auth-choice')}>
            Login / Register
          </button>
        </nav>
      </header>
      <main className='landing-main'>
        <div className='hero-section'>
          ...
          <button className='hero-button' onClick={() => setPage('auth-choice')}>
