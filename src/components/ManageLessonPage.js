...
function ManageLessonPage({ currentUser, selectedLesson, setPage }) {
  ...
  const handleAddVideo = async (e) => {
    ...
    try {
      ...
      const fileName = `${lesson.id}/${Date.now()}-${Math.random().toString(36).slice(2)}.${fileExt}`;
  ...
  const handleAddAttachment = async (e) => {
    ...
    try {
      ...
      const fileName = `${lesson.id}/attachments/${Date.now()}-${Math.random().toString(36).slice(2)}.${fileExt}`;
  ...
  return (
    <div className="main-container">
      <header className="main-header">
        <h2>Lesson {lesson.order_index}: {lesson.title}</h2>
            ...
            <form onSubmit={handleAddVideo}>
              ...
              <div className="form-group">
                ...
                <input
                  ...
                  onChange={(e) => setNewVideo(prev => ({ ...prev, mandatoryWatchPercentage: e.target.value }))}
                />
            ...
            <form onSubmit={handleAddAttachment}>
              ...
              <div className="form-group">
                <label style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                  <input
                    ...
                    onChange={(e) => setNewAttachment(prev => ({ ...prev, isMandatory: e.target.checked }))}
                  />
                  Mandatory Download
                </label>
              </div>
              ...
              <div className="form-group">
                ...
                <input
                  ...
                  type="file"
                  onChange={(e) => setNewAttachment(prev => ({ ...prev, attachmentFile: e.target.files[0] }))}
                  required
                />
                <small style={{ color: '#666', fontSize: '0.875rem' }}>
