    ...
    if (children.length === 0) {
        return (
            <div className="no-children-message">
                ...
                <button className="btn-primary" onClick={() => window.location.href = '/parent-dashboard'}>
                        ...
                        <div key={report.id} className="report-card">
                            <div className="report-header">
                                ...
                                <span className="overall-score">
                                    Overall: {report.report_data.overallAverage}%
                                </span>
                            </div>
                            ...
                            <div className="report-section">
                                ...
                                <p>
                                    Completed <strong>{report.report_data.totalQuizzes}</strong> quizzes with an average score of <strong>{report.report_data.overallAverage}%</strong>.
                                </p>
                            </div>
