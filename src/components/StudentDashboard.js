      ...
      <div className='content-body'>
        ...
        <div className='dashboard-grid'>
          <div className='card profile-info'>
            ...
            <div className='subscription-status'>
              ...
              <button className='btn-upgrade' onClick={() => setPage('subscriptions')}>
            ...
            <div className='quick-stats'>
              <div className='stat-item'>
                ...
                <div>
                  <div className='stat-value'>{currentUser.points_balance || 0}</div>
          ...
          <div className='card start-quiz'>
            ...
            {loadingQuizzesToday ? (
              ...
              <>
                <p>
                  You have <strong>{dailyQuizLimit - quizzesToday}</strong> free quizzes left today.
                </p>
              ...
              <div className='limit-reached'>
                ...
                <button className='upgrade-button' onClick={() => setPage('upgrade')}>
                  Upgrade to Premium
                </button>
              </div>
            )}
        ...
        <div className='dashboard-grid'>
          ...
          <div className='card manage-lessons-card'>
            <h3>
              <FiClock className='card-icon' /> My Lessons
            </h3>
            <p>View your upcoming lessons or find a new teacher.</p>
            <div className='dashboard-buttons'>
              <button className='my-lessons-btn' onClick={() => setPage('student-bookings')}>
                My Lessons
              </button>
              <button className='browse-teachers-btn' onClick={() => setPage('browse-teachers')}>
                Find a Teacher
              </button>
              <button className='certificates-btn' onClick={() => setPage('student-certificates')}>
                My Certificates
              </button>
            </div>
          </div>
          ...
          <div className='card premium-features'>
            <h3>
              <FiStar className='card-icon' /> Premium Features
            </h3>
            ...
            <button className='btn-premium' onClick={() => setPage('subscriptions')}>
          ...
          <div className='card payment-card'>
            <h3>
              <FiDollarSign className='card-icon' /> Payment & Billing
            </h3>
            <p>Manage your subscription, view payment history, and update billing information.</p>
            <div className='payment-buttons'>
              <button className='btn-payment' onClick={() => setPage('subscription-management')}>
                Manage Subscription
              </button>
              <button className='btn-payment-history' onClick={() => setPage('payment-history')}>
                Payment History
              </button>
            </div>
          </div>
          ...
          <div className='card shop-card'>
            <h3>
              <FiShoppingBag className='card-icon' /> Premium Shop
            </h3>
