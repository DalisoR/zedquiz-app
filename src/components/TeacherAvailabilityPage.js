            ...
            <div className="content-body">
                ...
                <div className="card">
                    ...
                    <p style={{ marginBottom: '1rem', color: '#666' }}>
                        Set your available hours for each day of the week. Students will only be able to book during these times.
                    </p>
                    
                    <div className="schedule-grid" style={{ display: 'grid', gap: '1rem' }}>
                        {daysOfWeek.map(({ key, label }) => (
                            <div key={key} className="day-schedule" style={{
                                display: 'grid',
                    ...
                    <div style={{ marginTop: '2rem' }}>
                        <button type="button" onClick={handleUpdateAvailability} disabled={loading} style={{
                            backgroundColor: '#3b82f6',
                            color: 'white',
                            padding: '0.75rem 1.5rem',
                            border: 'none',
