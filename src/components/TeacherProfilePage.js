                ...
                <div className="card">
                    <form onSubmit={handleUpdateProfile}>
                        <div className="form-group">
                            ...
                            {profilePicUrl && <img src={profilePicUrl} alt="Profile" className="profile-pic-preview" />}
                            <input id="profile-pic" type="file" accept="image/*" onChange={(e) => setProfilePicFile(e.target.files[0])} />
                        </div>
                        <div className="form-group">
                            <label htmlFor="bio">My Bio</label>
                            <textarea id="bio" value={bio} onChange={(e) => setBio(e.target.value)} placeholder="Write a short introduction about your teaching experience and style..." />
                        </div>
                        <div className="form-group">
                            <label htmlFor="subjects">Subjects I Teach</label>
                            <input id="subjects" type="text" value={subjects} onChange={(e) => setSubjects(e.target.value)} placeholder="e.g., Maths, Physics, English" />
                        </div>
