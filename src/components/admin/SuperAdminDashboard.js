...
function SuperAdminDashboard() {
  ...
  const fetchDashboardData = async () => {
    ...
    try {
      ...
      const { data: revenueData } = await supabase.rpc('get_revenue_dashboard').single();
    ...
    <div>
      ...
      <div className='card'>
        ...
        >
          ...
          <button
            onClick={() => navigate('/admin/analytics/subscriptions')}
            style={{
              padding: '1.5rem',
              background: '#3b82f6',
              color: 'white',
      ...
      <div className='card'>
        ...
        >
          <button
            onClick={() => navigate('/admin/marketing/discounts')}
            style={{
              padding: '1.5rem',
              background: '#8b5cf6',
              color: 'white',
          ...
          <button
            onClick={() => navigate('/admin/marketing/referrals')}
            style={{
              padding: '1.5rem',
              background: '#f59e0b',
              color: 'white',
        ...
        <ul className='application-list'>
          {applications.map(app => (
            <li key={app.id}>
              ...
              <button className='review-button' onClick={() => handleReview(app)}>
                Review
              </button>
            </li>
          ))}
