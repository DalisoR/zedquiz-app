          ...
          <div className='flex space-x-2'>
            <button
              ...
              className={`px-3 py-1 text-sm rounded-full ${
                timeRange === 'week' ? 'bg-blue-100 text-blue-700' : 'bg-gray-100 text-gray-700'
              }`}
            >
              This Week
            </button>
            <button
              ...
              className={`px-3 py-1 text-sm rounded-full ${
                timeRange === 'month' ? 'bg-blue-100 text-blue-700' : 'bg-gray-100 text-gray-700'
              }`}
            >
              This Month
            </button>
            <button
              ...
              className={`px-3 py-1 text-sm rounded-full ${
                timeRange === 'all' ? 'bg-blue-100 text-blue-700' : 'bg-gray-100 text-gray-700'
              }`}
            >
              All Time
            </button>
        ...
        {leaderboardData.length > 0 ? (
          leaderboardData.map((user, index) => (
            <div key={user.id} className='p-4 hover:bg-gray-50 flex items-center'>
              <div className='w-8 text-center font-medium text-gray-500'>{getMedal(index)}</div>
          ...
          <div className='flex items-center justify-between'>
            <div>
              ...
              <p className='text-sm text-gray-500'>
                ...
                {getOrdinalSuffix(userRank.rank)} place • {userRank.points.toLocaleString()} points
              </p>
            </div>
            <button
