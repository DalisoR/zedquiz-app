        ...
        {!isAffiliate ? (
          <div className="card" style={{ textAlign: 'center', maxWidth: '600px', margin: '0 auto' }}>
            ...
            <p style={{ margin: '0 0 2rem 0', fontSize: '1.125rem', color: '#666' }}>
              Earn 20% commission on every paid subscription you refer. Help others learn while earning money!
            </p>
                          ...
                          <td style={{ padding: '0.75rem', textAlign: 'center' }}>
                            <span style={{
                              ...
                              background: ref.status === 'completed' ? '#d1fae5' : 
                                         ref.status === 'pending' ? '#fef3c7' : '#fee2e2',
                              color: ref.status === 'completed' ? '#065f46' : 
                                     ref.status === 'pending' ? '#92400e' : '#dc2626'
                            }}>
