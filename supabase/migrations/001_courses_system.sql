...
-- Create chapter_quiz_attempts table (extends existing quiz system)
CREATE TABLE IF NOT EXISTS chapter_quiz_attempts (
    ...
    passed BOOLEAN DEFAULT false, -- true if score >= unlock_score_required
    attempt_number INTEGER DEFAULT 1,
    time_taken INTEGER, -- seconds
    answers JSONB,
    created_at TIMESTAMP WITH TIME ZONE DEFAULT NOW(),
    UNIQUE(student_id, chapter_id, attempt_number)
);
