...
CREATE INDEX idx_courses_teacher_subject ON courses(teacher_id, subject, grade_level);
...
CREATE INDEX idx_video_progress_student_video ON video_progress(student_id, video_id);
CREATE INDEX idx_enrollments_student ON student_course_enrollments(student_id);
CREATE INDEX idx_chapter_quiz_questions_quiz_order ON chapter_quiz_questions(quiz_id, order_index);
CREATE INDEX idx_chapter_quiz_attempts_student_quiz ON chapter_quiz_attempts(student_id, quiz_id);
